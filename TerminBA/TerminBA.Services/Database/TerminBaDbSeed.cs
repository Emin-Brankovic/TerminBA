    ...
    public partial class TerminBaContext : DbContext
    {
        ...
        private void SeedUsers(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                MakeUser(1,  "Admin",   "Admin",    "admin.korisnik@gmail.com",  "+38761123456", roleId: 3, cityId: 1, birthDate, d1, "admin"),
                MakeUser(2,  "Emin",     "Brankovic", "emin.brankovic19@gmail.com",   "+38761123456", roleId: 1, cityId: 1, birthDate, d2, "Vaha"),
        ...
        private void SeedSportCenters(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SportCenter>().HasData(
                MakeSportCenter(1, "Stadion Grbavica", "Grbavica 1, Sarajevo",  "stadion.grbavica",  "+38761123470", roleId: 2, cityId: 1, isEquipmentProvided: true,  "Premier football stadium with modern facilities",       createdAt),
                MakeSportCenter(2, "Basketball Arena", "Centar, Banja Luka",    "basketball.arena",  "+38761123471", roleId: 2, cityId: 2, isEquipmentProvided: true,  "Professional basketball court with indoor facilities",  createdAt),
                MakeSportCenter(3, "Tennis Club Tuzla", "Slatina, Tuzla",       "tennis.tuzla",      "+38761123472", roleId: 2, cityId: 3, isEquipmentProvided: false, "Outdoor tennis courts with clay and hard court surfaces", createdAt),
                MakeSportCenter(4, "Skenderija", "Terezija bb, Sarajevo", "skenderija.sports", "+38761123473", roleId: 2, cityId: 1, isEquipmentProvided: true, "Huge indoor complex in the heart of Sarajevo", createdAt),
                MakeSportCenter(5, "Mostar Indoor Arena", "Zalik, Mostar",      "mostar.arena",      "+38761123474", roleId: 2, cityId: 5, isEquipmentProvided: true,  "Great indoor arena for various sports", createdAt),
                MakeSportCenter(6, "Zenica Sports Center", "Kamberovica polje, Zenica", "zenica.sports", "+38761123475", roleId: 2, cityId: 4, isEquipmentProvided: true, "Main sports complex in Zenica", createdAt),
                MakeSportCenter(7, "Doboj Football Academy", "Usora, Doboj", "doboj.academy", "+38761123476", roleId: 2, cityId: 8, isEquipmentProvided: true, "Top football academy with multiple fields", createdAt),
                MakeSportCenter(8, "Konjic Tennis Complex", "Koviljuse, Konjic", "konjic.tennis", "+38761123477", roleId: 2, cityId: 6, isEquipmentProvided: false, "Large complex of professional tennis courts", createdAt),
                MakeSportCenter(9, "Travnik Indoor Arena", "Pecani, Travnik", "travnik.arena", "+38761123478", roleId: 2, cityId: 7, isEquipmentProvided: true, "Modern indoor arena for multiple sports", createdAt),
                MakeSportCenter(10, "Ramiz Salcin", "Semira Frašte 21, Sarajevo", "ramiz.salcin", "+38761123479", roleId: 2, cityId: 1, isEquipmentProvided: true, "Large sports complex with multi-purpose courts", createdAt)
            );
        }
        ...
        private static void SeedSportCenterSports(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity("SportSportCenter").HasData(
                ...
                new { AvailableSportsId = 2, SportCentarsId = 1 },
                new { AvailableSportsId = 2, SportCentarsId = 2 },
                new { AvailableSportsId = 4, SportCentarsId = 2 },
                new { AvailableSportsId = 5, SportCentarsId = 2 },
        ...
        private static void SeedFacilities(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Facility>().HasData(
                ...
                new Facility { Id = 7, Name = "Indoor Handball Court",MaxCapacity = 14,IsDynamicPricing = true,  StaticPrice = null,    IsIndoor = true,  Duration = TimeSpan.FromHours(1.5), SportCenterId = 5, TurfTypeId = 5, CreatedAt = createdAt, UpdatedAt = createdAt },
                ...
                new Facility { Id = 15, Name = "Konjic Handball Court",MaxCapacity=14,IsDynamicPricing= false, StaticPrice = 45.00m,  IsIndoor = true,  Duration = TimeSpan.FromHours(1.5), SportCenterId = 9, TurfTypeId = 5, CreatedAt = createdAt, UpdatedAt = createdAt },
        ...
        private static void SeedFacilitySports(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity("FacilitySport").HasData(
                new { AvailableSportsId = 1, FacilitiesId = 1 },  // Football  → Main Football Field
                new { AvailableSportsId = 2, FacilitiesId = 2 },  // Basketball→ Basketball Court A
                new { AvailableSportsId = 3, FacilitiesId = 3 },  // Tennis    → Tennis Court 1
                new { AvailableSportsId = 4, FacilitiesId = 4 },  // Volleyball→ Volleyball Court
                new { AvailableSportsId = 2, FacilitiesId = 5 },  // Basketball -> Basketball Court 1
                new { AvailableSportsId = 4, FacilitiesId = 6 },  // Volleyball -> Volleyball Area
                new { AvailableSportsId = 5, FacilitiesId = 7 },  // Handball -> Indoor Handball Court
                new { AvailableSportsId = 1, FacilitiesId = 7 },  // Football -> Indoor Handball Court
                new { AvailableSportsId = 4, FacilitiesId = 7 },  // Volleyball -> Indoor Handball Court
                new { AvailableSportsId = 1, FacilitiesId = 8 },  // Football -> Zenica Football Field
                new { AvailableSportsId = 2, FacilitiesId = 9 },  // Basketball -> Zenica Basketball Court
                new { AvailableSportsId = 1, FacilitiesId = 10 }, // Football -> Doboj Main Field
                new { AvailableSportsId = 1, FacilitiesId = 11 }, // Football -> Doboj Training Field
                new { AvailableSportsId = 3, FacilitiesId = 12 }, // Tennis -> Bijeljina Center Court
                new { AvailableSportsId = 3, FacilitiesId = 13 }, // Tennis -> Bijeljina Court 2
                new { AvailableSportsId = 3, FacilitiesId = 14 }, // Tennis -> Bijeljina Court 3
                new { AvailableSportsId = 5, FacilitiesId = 15 }, // Handball -> Prijedor Handball Court
                new { AvailableSportsId = 1, FacilitiesId = 15 }, // Football -> Prijedor Handball Court
                new { AvailableSportsId = 4, FacilitiesId = 15 }, // Volleyball -> Prijedor Handball Court
                new { AvailableSportsId = 2, FacilitiesId = 16 }, // Basketball -> Sarajevo Main Hall
                new { AvailableSportsId = 4, FacilitiesId = 16 }, // Volleyball -> Sarajevo Main Hall
                new { AvailableSportsId = 2, FacilitiesId = 17 }  // Basketball -> Sarajevo Secondary Hall
            );
        }
        ...
        private static void SeedFacilityDynamicPrices(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FacilityDynamicPrice>().HasData(
                new FacilityDynamicPrice { Id = 1, FacilityId = 1, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(8,  0), EndTime = new TimeOnly(17, 0), PricePerHour = 60.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 2, FacilityId = 1, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(17, 0), EndTime = new TimeOnly(22, 0), PricePerHour = 80.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 3, FacilityId = 1, StartDay = DayOfWeek.Saturday, EndDay = DayOfWeek.Sunday,  StartTime = new TimeOnly(9,  0), EndTime = new TimeOnly(20, 0), PricePerHour = 90.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 4, FacilityId = 3, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(6,  0), EndTime = new TimeOnly(18, 0), PricePerHour = 45.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 5, FacilityId = 3, StartDay = DayOfWeek.Saturday, EndDay = DayOfWeek.Sunday,  StartTime = new TimeOnly(8,  0), EndTime = new TimeOnly(19, 0), PricePerHour = 55.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 6, FacilityId = 7, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(8,  0), EndTime = new TimeOnly(16, 0), PricePerHour = 50.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 7, FacilityId = 7, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(16, 0), EndTime = new TimeOnly(23, 0), PricePerHour = 70.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 8, FacilityId = 7, StartDay = DayOfWeek.Saturday, EndDay = DayOfWeek.Sunday,  StartTime = new TimeOnly(9,  0), EndTime = new TimeOnly(23, 0), PricePerHour = 80.00m, ValidFrom = today, ValidTo = null },
                // Some dynamic prices for the new facilities
                new FacilityDynamicPrice { Id = 9, FacilityId = 10, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(8,  0), EndTime = new TimeOnly(16, 0), PricePerHour = 50.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 10, FacilityId = 10, StartDay = DayOfWeek.Monday,   EndDay = DayOfWeek.Friday,  StartTime = new TimeOnly(16, 0), EndTime = new TimeOnly(22, 0), PricePerHour = 75.00m, ValidFrom = today, ValidTo = null },
                new FacilityDynamicPrice { Id = 11, FacilityId = 12, StartDay = DayOfWeek.Saturday, EndDay = DayOfWeek.Sunday,  StartTime = new TimeOnly(8,  0), EndTime = new TimeOnly(20, 0), PricePerHour = 60.00m, ValidFrom = today, ValidTo = null }
            );
        }

        private static void SeedReservations(ModelBuilder modelBuilder)
        {
            var dateDec = new DateOnly(2025, 12, 10);
            ...
            modelBuilder.Entity<Reservation>().HasData(
                new Reservation { Id = 1, UserId = 2, FacilityId = 1, ReservationDate = dateJan, StartTime = new TimeOnly(18, 0), EndTime = new TimeOnly(19, 30), Status = nameof(CompletedReservationState), Price = 120.00m, ChosenSportId = 1 },
                new Reservation { Id = 2, UserId = 3, FacilityId = 2, ReservationDate = dateFeb, StartTime = new TimeOnly(19, 0), EndTime = new TimeOnly(20,  0), Status = nameof(CompletedReservationState), Price = 50.00m,  ChosenSportId = 2 },
                new Reservation { Id = 3, UserId = 4, FacilityId = 3, ReservationDate = dateMar, StartTime = new TimeOnly(10, 0), EndTime = new TimeOnly(11,  0), Status = nameof(CompletedReservationState), Price = 45.00m,  ChosenSportId = 3 },
                new Reservation { Id = 4, UserId = 2, FacilityId = 1, ReservationDate = dateApr, StartTime = new TimeOnly(20, 0), EndTime = new TimeOnly(21, 30), Status = nameof(CompletedReservationState), Price = 120.00m, ChosenSportId = 1 },
                new Reservation { Id = 5, UserId = 3, FacilityId = 4, ReservationDate = dateMay, StartTime = new TimeOnly(16, 0), EndTime = new TimeOnly(17, 30), Status = nameof(CompletedReservationState), Price = 60.00m,  ChosenSportId = 4 },
                new Reservation { Id = 6, UserId = 5, FacilityId = 5, ReservationDate = dateJun, StartTime = new TimeOnly(18, 0), EndTime = new TimeOnly(19, 30), Status = nameof(CompletedReservationState), Price = 30.00m,  ChosenSportId = 2 },
                new Reservation { Id = 7, UserId = 6, FacilityId = 6, ReservationDate = dateJul, StartTime = new TimeOnly(17, 0), EndTime = new TimeOnly(18, 0), Status = nameof(CompletedReservationState), Price = 20.00m,  ChosenSportId = 4 },
                new Reservation { Id = 8, UserId = 7, FacilityId = 7, ReservationDate = dateAugPast, StartTime = new TimeOnly(20, 0), EndTime = new TimeOnly(21, 30), Status = nameof(CompletedReservationState), Price = 70.00m,  ChosenSportId = 5 },
                new Reservation { Id = 9, UserId = 8, FacilityId = 8, ReservationDate = dateJan, StartTime = new TimeOnly(15, 0), EndTime = new TimeOnly(16, 30), Status = nameof(CompletedReservationState), Price = 80.00m,  ChosenSportId = 1 },
                new Reservation { Id = 10, UserId = 2, FacilityId = 9, ReservationDate = dateFeb, StartTime = new TimeOnly(18, 0), EndTime = new TimeOnly(19,  0), Status = nameof(CompletedReservationState), Price = 40.00m,  ChosenSportId = 2 },
                new Reservation { Id = 11, UserId = 3, FacilityId = 10, ReservationDate = dateMar, StartTime = new TimeOnly(20, 0), EndTime = new TimeOnly(21, 30), Status = nameof(CompletedReservationState), Price = 60.00m,  ChosenSportId = 1 },
                new Reservation { Id = 12, UserId = 4, FacilityId = 11, ReservationDate = dateApr, StartTime = new TimeOnly(19, 0), EndTime = new TimeOnly(20, 30), Status = nameof(CompletedReservationState), Price = 40.00m,  ChosenSportId = 1 },
                new Reservation { Id = 13, UserId = 5, FacilityId = 12, ReservationDate = dateAugFuture, StartTime = new TimeOnly(10, 0), EndTime = new TimeOnly(11,  0), Status = nameof(ActiveReservationState), Price = 50.00m,  ChosenSportId = 3 },
                new Reservation { Id = 14, UserId = 6, FacilityId = 13, ReservationDate = dateSep, StartTime = new TimeOnly(11, 0), EndTime = new TimeOnly(12,  0), Status = nameof(ActiveReservationState), Price = 30.00m,  ChosenSportId = 3 },
                new Reservation { Id = 15, UserId = 2, FacilityId = 14, ReservationDate = dateSep, StartTime = new TimeOnly(12, 0), EndTime = new TimeOnly(13,  0), Status = nameof(ActiveReservationState), Price = 30.00m,  ChosenSportId = 3 },
                new Reservation { Id = 16, UserId = 7, FacilityId = 15, ReservationDate = dateOct, StartTime = new TimeOnly(18, 0), EndTime = new TimeOnly(19, 30), Status = nameof(ActiveReservationState), Price = 45.00m,  ChosenSportId = 5 },
                new Reservation { Id = 17, UserId = 8, FacilityId = 16, ReservationDate = dateOct, StartTime = new TimeOnly(19, 0), EndTime = new TimeOnly(20,  0), Status = nameof(ActiveReservationState), Price = 100.00m, ChosenSportId = 2 },
                new Reservation { Id = 18, UserId = 9, FacilityId = 17, ReservationDate = dateNov, StartTime = new TimeOnly(20, 0), EndTime = new TimeOnly(21, 30), Status = nameof(ActiveReservationState), Price = 70.00m,  ChosenSportId = 2 },
                new Reservation { Id = 19, UserId = 10, FacilityId = 1, ReservationDate = dateNov, StartTime = new TimeOnly(17, 0), EndTime = new TimeOnly(18, 30), Status = nameof(ActiveReservationState), Price = 120.00m, ChosenSportId = 1 },
                new Reservation { Id = 20, UserId = 11, FacilityId = 2, ReservationDate = dateDecFuture, StartTime = new TimeOnly(18, 0), EndTime = new TimeOnly(19, 0), Status = nameof(ActiveReservationState), Price = 50.00m,  ChosenSportId = 2 }
            );
        }
        ...
        private static void SeedPosts(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Post>().HasData(
                new Post { Id = 1, SkillLevel = "Intermediate", NumberOfPlayersWanted = 3, NumberOfPlayersFound = 1, Text = "Looking for players for a friendly match", ReservationId = 1, PostState = nameof(PlayerSearchPostState) },
                new Post { Id = 2, SkillLevel = "Beginner",     NumberOfPlayersWanted = 2, NumberOfPlayersFound = 0, Text = "Need players for basketball game",          ReservationId = 2, PostState = nameof(PlayerSearchPostState) },
                new Post { Id = 3, SkillLevel = "Advanced",     NumberOfPlayersWanted = 1, NumberOfPlayersFound = 1, Text = "Looking for a tennis partner",              ReservationId = 3, PostState = nameof(PlayerFoundPostState)  },
                new Post { Id = 4, SkillLevel = "Intermediate", NumberOfPlayersWanted = 4, NumberOfPlayersFound = 2, Text = "Football match - need more players",        ReservationId = 4, PostState = nameof(PlayerSearchPostState) },
                new Post { Id = 5, SkillLevel = "Intermediate", NumberOfPlayersWanted = 2, NumberOfPlayersFound = 0, Text = "Volleyball players needed",                 ReservationId = 5, PostState = nameof(PlayerSearchPostState) },
                new Post { Id = 6, SkillLevel = "Beginner",     NumberOfPlayersWanted = 5, NumberOfPlayersFound = 2, Text = "Casual basketball game",                    ReservationId = 6, PostState = nameof(PlayerSearchPostState) }
            );
        }

        private static void SeedPlayRequests(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<PlayRequest>().HasData(
                new PlayRequest { Id = 1, PostId = 1, RequesterId = 10, PlayRequestState = nameof(AcceptedPlayRequestState), RequestText = "I'd like to join your game", DateOfRequest = new DateTime(2026, 1, 10, 10, 0, 0, DateTimeKind.Utc), DateOfResponse = new DateTime(2026, 1, 12, 10, 0, 0, DateTimeKind.Utc) },
                new PlayRequest { Id = 2, PostId = 2, RequesterId = 11, PlayRequestState = nameof(PendingPlayRequestState),  RequestText = "Can I join?",               DateOfRequest = new DateTime(2026, 2, 20, 10, 0, 0, DateTimeKind.Utc) },
                new PlayRequest { Id = 3, PostId = 3, RequesterId = 2,  PlayRequestState = nameof(AcceptedPlayRequestState), RequestText = "I'm available for tennis",   DateOfRequest = new DateTime(2026, 3, 10, 10, 0, 0, DateTimeKind.Utc), DateOfResponse = new DateTime(2026, 3, 12, 10, 0, 0, DateTimeKind.Utc) },
                new PlayRequest { Id = 4, PostId = 4, RequesterId = 3,  PlayRequestState = nameof(AcceptedPlayRequestState), RequestText = "Count me in for football",   DateOfRequest = new DateTime(2026, 4, 1, 10, 0, 0, DateTimeKind.Utc), DateOfResponse = new DateTime(2026, 4, 2, 10, 0, 0, DateTimeKind.Utc) },
                new PlayRequest { Id = 5, PostId = 4, RequesterId = 6,  PlayRequestState = nameof(AcceptedPlayRequestState), RequestText = "I want to play",             DateOfRequest = new DateTime(2026, 4, 3, 10, 0, 0, DateTimeKind.Utc), DateOfResponse = new DateTime(2026, 4, 5, 10, 0, 0, DateTimeKind.Utc) }
            );
        }
        ...
        private static void SeedUserReviews(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<UserReview>().HasData(
                new UserReview { Id = 1, RatingNumber = 5, RatingDate = new DateOnly(2026, 1, 21), Comment = "Great player, very fair",  ReviewerId = 2, ReviewedId = 10, ReservationId = 1 },
                new UserReview { Id = 2, RatingNumber = 4, RatingDate = new DateOnly(2026, 2, 26), Comment = "Good teammate",            ReviewerId = 3, ReviewedId = 11, ReservationId = 2 },
                new UserReview { Id = 3, RatingNumber = 5, RatingDate = new DateOnly(2026, 3, 16), Comment = "Excellent sportsmanship",  ReviewerId = 4, ReviewedId = 2,  ReservationId = 3 },
                new UserReview { Id = 4, RatingNumber = 4, RatingDate = new DateOnly(2026, 4, 11), Comment = "Reliable player",          ReviewerId = 2, ReviewedId = 3,  ReservationId = 4 },
        ...
        private SportCenter MakeSportCenter(int id, string name, string address, string username,
            string phoneNumber, int roleId, int cityId, bool isEquipmentProvided, string description, DateTime createdAt)
        {
            var salt = "8B/80a0tP2L4/w0k4/4qJ+s2x+0zO5R+jQ4aM+q8t3g=";
            var hash = HashingHelper.GenerateHash(salt, plainPassword);
