...
class SportCenterUpdateRequest {
  ...
  List<WorkingHoursInsertRequest> workingHours;
	...
	SportCenterUpdateRequest(this.username,this.displayName,this.phoneNumber,this.contactEmail,this.cityId,this.address,this.isEquipmentProvided,this.description,this.sportIds,this.amenityIds,this.workingHours);
